            ...
            <div class="glass-card animate-slide-up" style="margin-bottom: 25px; padding: 25px; background: rgba(34, 197, 94, 0.03); border: 1px solid rgba(34, 197, 94, 0.2);">
                ...
                <div style="display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-end;">
                    <div style="flex: 1; min-width: 250px;">
                        ...
                        <select id="sim-regime" class="form-control" style="background: rgba(0,0,0,0.3);" onchange="updateSimInputs(this.value)">
                            ${AVANTAGES_CATALOG.map(a => `<option value="${a.id}">${a.icon} ${t(a.title_key) || a.title_fallback}</option>`).join('')}
                        </select>
                    </div>
                    <div id="sim-dynamic-inputs" style="flex: 2; display: flex; gap: 15px; flex-wrap: wrap;">
        ...
        if (id === 'auto_entrepreneur') {
            ...
            html += `
                <div style="flex: 1; min-width: 200px;">
                    <label style="font-size: 0.85rem; color: #94a3b8; margin-bottom: 5px; display: block;">Bénéfice estimé (DT)</label>
